...
SELECT name, region FROM country WHERE region IN ('North America', 'South America', 'Caribbean', 'Central America');
...
SELECT name, region FROM country WHERE region IN ('North America', 'South America', 'Central America');
