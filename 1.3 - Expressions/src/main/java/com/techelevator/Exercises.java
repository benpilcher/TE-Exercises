...
public class Exercises {
	...
	public int max1020(int a, int b) {
		if (((a >= 10) && (a <= 20)) && (((b < 10) || (b > 20)) || (a >= b))) {
			return a;
		} else if (((b >= 10) && (b <= 20)) && (((a < 10) || (a > 20)) || (b >= a))) {
			return b;
		} else {
			return 0;
		}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
    	String result = "ginormous";

    	if ((mealAmount < 6) || (((mealAmount >= 6) && (mealAmount <= 10)) && !isBirthday)) {
        	result = "standard";
        } else if ((((mealAmount >= 6) && (mealAmount <= 10)) && isBirthday) || (((mealAmount > 10) && (mealAmount <= 15)) && !isBirthday)) {
        	result = "special";
        }
    	return result;
    }
	...
	public String alarmClock(int day, boolean vacation) {
		...
		if (((day >= 1) && (day <= 5)) && !vacation) {
			result = "7:00";
		} else if ((((day >= 1) && (day <= 5)) && vacation) || (((day == 0) || (day == 6)) && !vacation)) {
			result = "10:00";
		}
		return result;
	}
